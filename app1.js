...
function get() {
    ...
    var add_i = document.getElementById("addr").value;
    ...
    // Constructor
    function Info (name_i, add_i, age_i, education_i, profession_i, gender_i) {
  ...
  var result = new Info(name_i, add_i, age_i, education_i, profession_i, gender_i);
  // var result = new Info("Shahabuddin", "sec 5j new khi", 20, "Inter", "Teacher", "male");
  console.log(result);
}